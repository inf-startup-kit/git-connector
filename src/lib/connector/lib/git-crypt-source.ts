...
import { IConnectorGitCryptSourceConfig, IConnectorSource, IConnectorSourceEvent } from "../interfaces";
...
export class ConnectorGitCryptSource extends EventEmitter implements IConnectorSource {
    ...
    constructor (
        ...
        private readonly _config: IConnectorGitCryptSourceConfig,
